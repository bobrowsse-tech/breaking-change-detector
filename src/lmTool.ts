...
export function registerCheckBreakingChangesTool(context: vscode.ExtensionContext) {
  context.subscriptions.push(
    vscode.lm.registerTool("check_breaking_changes", {
      async invoke(
        ...
        const result = "check_breaking_changes is not yet implemented \u2014 see DIRECTIVE.md";
